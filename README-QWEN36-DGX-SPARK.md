...
The supported path uses the Spark Arena TF5 image and mounts this fork's
optimized GDN files into the container. This is the same deployment shape used
for the benchmarked recipe: DFlash k=15, fp16 GDN SSM cache, CUDA graphs
disabled, and `VLLM_QWEN_GDN_T16_COMMIT1_UNPAIRED=1`.
